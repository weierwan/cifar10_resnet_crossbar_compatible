...
x_train = quantize_rescale(quantize_unsigned(x_train, activation_bits, 0.95), activation_bits, 0.95)
x_test = quantize_rescale(quantize_unsigned(x_test, activation_bits, 0.95), activation_bits, 0.95)
