...
if len(sys.argv) == 2:
    weight_noise = None
    model_name = '12filt_act%db_wnoiseNone' % activation_bits
else:
    weight_noise = float(sys.argv[2])
    model_name = '12filt_act%db_wnoise%.1f' % (activation_bits, weight_noise)
...
model_full_name = 'cifar10_%s_model.{epoch:03d}.h5' % model_type
